...
async def test_basic_search():
    ...
    print(f"\n✅ Found {len(jobs)} Python jobs in San Francisco")
...
async def test_location_specific():
    ...
    print(f"\n✅ Found {len(jobs)} DevOps/K8s jobs in Denver area")
...
async def test_title_filtering():
    ...
    print(f"\n✅ Found {len(jobs)} senior Python engineering roles")
...
async def test_pagination():
    ...
    print(f"\n✅ Total jobs across pages: {len(all_jobs)}")
