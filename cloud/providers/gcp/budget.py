...
async def setup_budget_alerts(logger, project_id: str, region: str, project_root: Path, scheduler_region: str, job_name: str) -> None:
    ...
    result = await run_command([
        ...
        "--quiet"
    ], check=False, logger=logger, show_spinner=True, capture_output=True)
