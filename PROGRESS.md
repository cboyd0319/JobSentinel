...
- Current slice: `jobsentinel-application` now constructs configuration,
  ...
  91 net no-growth exceptions, reducing the total from 109 to 18. The latest
  CoverLetterTemplates, JobCard, and NotificationPreferences test-suite splits
  passed focused checks and the full local repository gate.
- Next action: reduce the remaining 18 structural exceptions, then run the
