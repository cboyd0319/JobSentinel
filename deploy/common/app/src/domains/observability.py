...
class MetricsCollector:
    ...
    def record_histogram(self, name: str, value: float, labels: dict[str, str] | None = None):
        ...
        """
        metric = Metric(
            name=name, value=value, metric_type=MetricType.HISTOGRAM, labels=labels or {}
        )
        self.metrics.append(metric)
    ...
    def record_performance(
        ...
        self.record_histogram(
            f"{operation}.duration_ms", duration_ms, labels={"success": str(success)}
        )
...
def track_performance(operation: str, metadata: dict[str, Any] | None = None):
    ...
    try:
        ...
        _metrics_collector.record_performance(
            operation=operation, duration_ms=duration_ms, success=success, metadata=metadata
        )
