...
class UltimateResumeScanner:
    ...
    def _analyze_keywords(
        self, job_description: str | None, industry: str | None
    ) -> KeywordAnalysis:
    ...
    def _generate_final_recommendations(
        ...
        if overall_score < 70:
            self.recommendations.insert(
                0, "URGENT: Your resume needs significant improvements to pass ATS screening"
            )
...
Examples:
  ...
  python ultimate_resume_scanner.py resume.pdf --industry software
    ...
    parser.add_argument("resume_path", help="Path to resume file (PDF, DOCX, or TXT)")
    parser.add_argument(
        "--job-description", "-j", help="Path to job description file for targeted analysis"
    )
    parser.add_argument(
        "--industry",
        "-i",
    ...
    parser.add_argument("--output", "-o", help="Path to save detailed HTML report")
