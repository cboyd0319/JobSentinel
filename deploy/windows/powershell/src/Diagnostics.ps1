...
#>
    ...
    #>
                ...
                $headingColour = "if" ($supportsStyle) { $PSStyle.Foreground.BrightCyan } else { ''  # Result stored for potential future use
                }
                $resetColour = "if" ($supportsStyle) { $PSStyle.Reset } else { ''  # Result stored for potential future use
                }
