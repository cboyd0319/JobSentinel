...
//!
//! ```
//! use jobsentinel_domain::normalization::normalize_title;
//!
...
const JOB_TITLE_NORMALIZATION_TAXONOMY_JSON: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../resources/taxonomies/job-title-normalization.json"
));
...
///
/// ```
/// use jobsentinel_domain::normalization::titles_match;
///
/// assert!(titles_match(
