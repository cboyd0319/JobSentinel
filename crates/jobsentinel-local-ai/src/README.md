...
2026-06-19 with
`qwen3::tests::qwen3_reranker_ranks_direct_evidence_above_near_miss`:
...
through `crates/jobsentinel-documents/src/resume_match_score.rs`; builds without
local ML keep the deterministic weighted formula.
