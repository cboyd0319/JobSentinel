...
mod ats_commands {
    use super::*;
    use jobsentinel_core::ats::{ApplicationStatus, ApplicationTracker};
...
mod salary_commands {
    use super::*;
    use jobsentinel_core::salary::{SalaryAnalyzer, SeniorityLevel};
...
mod market_commands {
    use super::*;
    use jobsentinel_core::market_intelligence::MarketIntelligence;
...
mod user_data_commands {
    use super::*;
    use jobsentinel_core::user_data::{SavedSearch, TemplateCategory, UserDataManager};
...
mod credential_commands {
    use jobsentinel_core::credentials::{CredentialKey, CredentialService};
    use jobsentinel_core::Database;
