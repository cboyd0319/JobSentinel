...
pub(in crate::core::resume::ats_analyzer) fn extract_physical_weight_keywords(
    text: &str,
) -> Vec<String> {
...
pub(in crate::core::resume::ats_analyzer) fn is_physical_weight_requirement(
    keyword_lower: &str,
) -> bool {
    PHYSICAL_WEIGHT_RE.is_match(keyword_lower)
}

pub(in crate::core::resume::ats_analyzer) fn physical_weight_search_terms(
    keyword_lower: &str,
) -> Vec<String> {
...
pub(in crate::core::resume::ats_analyzer) fn human_languages() -> &'static [String] {
    &TAXONOMY.human_languages
}

pub(in crate::core::resume::ats_analyzer) fn bullet_power_words() -> &'static [String] {
    &TAXONOMY.bullet_power_words
}

pub(in crate::core::resume::ats_analyzer) fn conservative_search_term_groups(
) -> &'static [Vec<String>] {
    &TAXONOMY.conservative_search_term_groups
}

pub(in crate::core::resume::ats_analyzer) fn base_industry_catalog_terms() -> &'static [String] {
    &TAXONOMY.base_industry_catalog_terms
}

pub(in crate::core::resume::ats_analyzer) fn canonical_requirement_keyword(
    keyword: &str,
) -> String {
...
pub(in crate::core::resume::ats_analyzer) fn role_specific_evidence_prompt(
    job_desc_lower: &str,
) -> Option<&'static str> {
    TAXONOMY
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_degree_equivalent_exclusion(
    keyword: &str,
) -> bool {
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_citizenship_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(&TAXONOMY.hard_constraint_keyword_sets.citizenship, keyword)
}

pub(in crate::core::resume::ats_analyzer) fn hard_constraint_work_authorization_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_security_clearance_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_license_or_certification_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
        &TAXONOMY
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_education_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(&TAXONOMY.hard_constraint_keyword_sets.education, keyword)
}

pub(in crate::core::resume::ats_analyzer) fn hard_constraint_experience_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(&TAXONOMY.hard_constraint_keyword_sets.experience, keyword)
}

pub(in crate::core::resume::ats_analyzer) fn hard_constraint_background_screening_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_physical_requirement_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_location_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(&TAXONOMY.hard_constraint_keyword_sets.location, keyword)
}

pub(in crate::core::resume::ats_analyzer) fn hard_constraint_driving_record_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_vehicle_insurance_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_age_requirement_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn hard_constraint_seniority_level_keyword(
    keyword: &str,
) -> bool {
    hard_constraint_keyword_set_matches(
...
pub(in crate::core::resume::ats_analyzer) fn extract_supplemental_keywords(
    text: &str,
) -> Vec<String> {
    let mut seen = HashSet::new();
    let mut keywords = Vec::new();
...
pub(in crate::core::resume::ats_analyzer) fn supplemental_keyword_catalog_terms() -> Vec<String> {
    let mut seen = HashSet::new();
    let mut terms = Vec::new();
...
pub(in crate::core::resume::ats_analyzer) fn supplemental_keyword_search_terms(
    keyword_lower: &str,
) -> Vec<String> {
...
pub(in crate::core::resume::ats_analyzer) fn extract_credential_keywords(
    text: &str,
) -> Vec<String> {
    let mut seen = HashSet::new();
    let mut keywords = Vec::new();
...
pub(in crate::core::resume::ats_analyzer) fn credential_keyword_search_terms(
    keyword_lower: &str,
) -> Vec<String> {
...
pub(in crate::core::resume::ats_analyzer) fn credential_keyword_catalog_terms() -> Vec<String> {
    let mut seen = HashSet::new();
    let mut terms = Vec::new();
...
pub(in crate::core::resume::ats_analyzer) fn specific_credential_keywords() -> HashSet<String> {
...
pub(in crate::core::resume::ats_analyzer) fn is_credential_keyword(keyword_lower: &str) -> bool {
