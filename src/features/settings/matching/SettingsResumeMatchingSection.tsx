        ...
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-3">
              <SettingsSymbol
                icon="document"
                className="h-6 w-6 text-surface-500 dark:text-surface-400"
              />
          ...
          <div className="mt-3 pt-3 border-t border-surface-200 dark:border-surface-700">
            <p className="flex items-start gap-1.5 text-xs text-surface-500 dark:text-surface-400">
              ...
              <span>
                ...
                <strong>Resume</strong> tab and review saved skills first. If no
                reviewed resume skills are saved, fit estimates use your job
