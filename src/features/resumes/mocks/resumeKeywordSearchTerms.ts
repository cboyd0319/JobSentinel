import {
  extendMockLanguageFluencyTerms,
  getMockExperienceYearSearchTerms,
  getMockPhysicalWeightSearchTerms,
  getMockSupplementalKeywordSearchTerms,
} from "./resumeKeywordSupplementalTerms";
