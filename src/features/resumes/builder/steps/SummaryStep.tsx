    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Customer success leader with 5+ years helping teams improve retention, onboarding, and support operations. Experienced in cross-functional projects, customer communication, and process improvement."
        />
