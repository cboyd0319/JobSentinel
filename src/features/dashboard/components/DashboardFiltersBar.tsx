...
import type { Job, SortOption, ScoreFilter, PostedDateFilter, GhostFilter, SavedSearch } from "../types";
  ...
  return (
    <div className="flex flex-col gap-4 mb-4">
      ...
      <DashboardBulkActions
        ...
        handleBulkBookmark={handleBulkBookmark}
        handleBulkExport={handleBulkExport}
        handleBulkHide={handleBulkHide}
        handleCompareJobs={handleCompareJobs}
