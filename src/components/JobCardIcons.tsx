...
export const HideIcon = memo(function HideIcon() {
  return (
    <svg
      className="w-5 h-5"
      fill="none"
...
export const SalaryIcon = memo(function SalaryIcon() {
  return (
    <svg
      className="w-4 h-4"
      fill="none"
...
export const BookmarkIcon = memo(function BookmarkIcon({
  filled = false,
}: {
  filled?: boolean;
}) {
...
export const RiskIcon = memo(function RiskIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export const DuplicateIcon = memo(function DuplicateIcon() {
  return (
    <svg
      className="w-4 h-4"
      fill="none"
