...
const variantStyles = {
  primary: "bg-sentinel-600 text-white hover:bg-sentinel-700 hover:shadow-soft hover:-translate-y-0.5 active:translate-y-0 active:bg-sentinel-800 focus-visible:ring-sentinel-500",
  ...
  success: "bg-green-700 text-white hover:bg-green-800 hover:shadow-soft hover:-translate-y-0.5 active:translate-y-0 focus-visible:ring-green-700",
  danger: "bg-red-700 text-white hover:bg-red-800 hover:shadow-soft hover:-translate-y-0.5 active:translate-y-0 focus-visible:ring-red-700",
};
