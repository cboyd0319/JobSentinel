...
export function SettingsCredentialLockSection() {
  ...
  const [activeAction, setActiveAction] =
    useState<CredentialLockAction | null>(null);
  ...
  const handleUnlock = useCallback(async () => {
    ...
    try {
      ...
      toastError("Saved details were not unlocked", getPassphraseActionMessage(error));
    } finally {
      setActiveAction(null);
    }
  ...
  const handleDisable = useCallback(async () => {
    ...
    try {
      ...
      toastError("System lock was not restored", getPassphraseActionMessage(error));
    } finally {
      setActiveAction(null);
    }
  }, [currentPassphrase, loadStatus, toastError, toastSuccess]);
  ...
  return (
    <section className="mb-6" aria-labelledby="settings-credential-lock-heading">
