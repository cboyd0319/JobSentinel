...
class BLSMCPServer:
    ...
    async def get_occupation_salary(
        self, occupation: str, location: str = "national", year: int | None = None
    ) -> BLSSalaryData | None:
        """
    ...
    async def compare_locations(
        self, occupation: str, locations: list[str]
    ...
    async def get_salary_percentile(
        self, occupation: str, salary: float, location: str = "national"
    ) -> float | None:
        """
        ...
        if data.percentile_10 and salary <= data.percentile_10:
            ...
            if data.percentile_25:
                ratio = (salary - data.percentile_25) / (
                    data.annual_median_wage - data.percentile_25
                )
            ...
            if data.annual_median_wage:
                ratio = (salary - data.annual_median_wage) / (
                    data.percentile_75 - data.annual_median_wage
                )
        ...
        return [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "occupation": {
                            "type": "string",
                            "description": "Occupation name or SOC code",
                        },
                        "location": {
                            "type": "string",
                            "description": "Location (default: national)",
                        },
