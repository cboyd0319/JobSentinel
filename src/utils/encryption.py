...
class DatabaseEncryption:
    ...
    def save_key_securely(key: str, key_path: Path) -> None:
        ...
        # Note: chmod fails on Windows; permissions handled by NTFS
        try:
    ...
    @staticmethod
    def load_key_securely(key_path: Path) -> str | None:
...
class KeyRotation:
    ...
    @staticmethod
    def rotate_field_encryption(old_key: bytes, new_key: bytes, encrypted_data: bytes) -> bytes:
