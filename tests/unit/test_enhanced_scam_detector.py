...
class TestEnhancedScamDetector:
    ...
    def test_advance_fee_fraud(self):
        ...
        assert any("fee" in i.pattern.lower() or "home" in i.pattern.lower() for i in result.indicators)
    ...
    def test_cryptocurrency_scam(self):
        ...
        assert result.is_scam is True
        assert any("bitcoin" in i.pattern.lower() or "crypto" in i.pattern.lower() for i in result.indicators)
