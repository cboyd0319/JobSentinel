...
class TestInputValidationProperties:
    ...
    @given(
        text=st.text(min_size=1, max_size=100), max_length=st.integers(min_value=1, max_value=1000)
    )
...
class TestValidationFrameworkProperties:
        ...
        try:
            ...
            if min_val <= value <= max_val:
                ...
                result = framework.validate_integer(
                    value, min_value=min_val, max_value=max_val, field_name="test_value"
                )
    ...
    def test_text_validation_never_crashes(self, text: str) -> None:
        ...
        try:
            ...
            result = framework.validate_string(text, field_name="test_field", max_length=500)
