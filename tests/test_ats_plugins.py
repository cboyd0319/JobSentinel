import pytest
from utils.ats_analyzer import ATSAnalyzer, register_analyzer_plugin, register_default_plugins
from utils.ats_analyzer import ATSAnalysisResult, Issue

SIMPLE_RESUME = "Action oriented engineer. Led migration. Implemented system. Increased performance 50%."
...
def test_plugin_failure_isolated():
    ...
    # Issue logged
    assert any(iss.category == "_boom_test" and "Plugin error" in iss.message for iss in result.issues)
