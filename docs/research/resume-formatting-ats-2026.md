...
- Application Assist includes management experience in common saved-answer
  patterns, so users can prepare a reusable management answer before a hard
...
- Application Assist includes physical requirements in common saved-answer
  patterns, so users can prepare a reusable physical-demand answer before a
  hard physical question appears.
...
- Application Assist shows matching saved salary, compensation, start-date,
  ...
  details mention pay or availability requirements.
