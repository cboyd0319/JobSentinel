...
- Pay gaps can reflect salary opacity, prior-pay anchoring, negotiation
  ambiguity, bias, occupational segregation, unequal access to referrals,
  discretionary pay setting, and unclear promotion criteria.
- Pay transparency and salary-history rules can reduce information asymmetry,
  but laws and data change by jurisdiction and date.
- Individual negotiation scripts are not a fix for structural inequity.
- Salary guidance can become harmful when it implies the user caused a pay gap by
  not asking correctly.
...
- Add guardrails for salary-history questions without giving unsourced legal
  advice.
- Do not infer protected-class traits for salary guidance.
