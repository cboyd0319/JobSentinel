...
- **Health Dashboard** - Check job source status from Settings > Troubleshooting
...
### Job Source Health Dashboard

Access from: **Settings > Troubleshooting > "View Job Source Health"**

| Feature | Description |
|---------|-------------|
| Summary Stats | Total sources, healthy/degraded/down/disabled counts |
| Source Table | Health status, recent success, average check time, jobs found |
