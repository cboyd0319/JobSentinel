...
- **Preferred and Blocked Companies** - Control job scoring by company
- **Fuzzy Name Matching** - Handles company suffixes (Inc, LLC, Corp)
- **Blocked Company Precedence** - Blocked companies always score 0
...
- **Partial-word match guard** - Prevents false matches
