# Changelog Archive: v2.0 To v2.4
...
- Seamless data flow from matcher to optimizer to builder
...
- Integration tests for resume to builder workflow
...
- **ScoreBreakdownModal Component** - Detailed score visualization in a modal
  ...
  - Visual status indicators (pass/fail) for each factor
