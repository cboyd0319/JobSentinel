# JobSentinel v2.5.0 - Hiring Trends UI
...
Complete visualization layer for the Hiring Trends module with interactive charts,
tabbed layout, and real-time hiring signals. This release transforms local job signals
...
The Hiring Trends page was completely rewritten with a professional tabbed layout:
...
- `src/ui/Badge.tsx` - Added className prop
- `src/components/index.ts` - Added new component exports
- `crates/jobsentinel-core/src/core/market_intelligence/queries.rs` - Enhanced query methods
- `crates/jobsentinel-core/src/core/market_intelligence/alerts.rs` - Added mark_alert_read
- `crates/jobsentinel-core/src/core/market_intelligence/mod.rs` - Added wrapper methods
- `crates/jobsentinel-core/src/core/market_intelligence/tests.rs` - Updated test structs
