...
| Lecture tuple | Tools | 5/5 | `package.json`, `scripts/check-harness.mjs`, `scripts/harness-session.mjs`, and `scripts/harness-score.mjs`. |
...
| Harness-creator tuple | Verification | 5/5 | `harness:check`, `harness:score`, `test:scripts`, verification matrix, focused tests. |
| Harness-creator tuple | Scope | 5/5 | Change contract, plan template, Rule 0, external-AI and bloat sensors. |
| Harness-creator tuple | Lifecycle | 5/5 | Session snapshot, score command, operating loop, and scorecard. |
