...
- Current state: Milestones 0 through 6 and Gates 0 through 4 are passing.
  ...
  through the same verified artifact boundary for bounded plain-text review and an advisory-only handoff. Product-target
  evaluation execution, production publisher trust, artifact-root binding, startup wiring, native source-pack drop,
