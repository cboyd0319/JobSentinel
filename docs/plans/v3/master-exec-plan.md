...
- Current state: Milestones 0 through 6 and Gates 0 through 4 are passing.
  ...
  and concurrent cleanup or later restaging cannot lose truth or delete a new artifact. Production root binding,
  publisher trust, startup wiring, native source-pack drop, pack UI, and platform live proof remain open.
