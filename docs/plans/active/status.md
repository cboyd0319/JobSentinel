...
| Full repository refactor and v2.9.5 readiness | Active | Continue the remaining frontend buckets after splitting validation ownership | [Plan](repository-architecture-reorganization.md) |
