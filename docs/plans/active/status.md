...
- Fresh 2026-06-18 post-`4287830a` local release gate passes: version,
  latest deps/actions, docs, harness score 100, scripts, security, bloat,
  external AI, Tauri invokes, test quality, npm audit, cargo-deny, doctor/e2e
  with Node 26 vs CI 24 warning, frontend lint/unit/build, Rust fmt/clippy/lib
  tests, E2E `266/266`, and macOS no-account 100% / full-public 94%.
