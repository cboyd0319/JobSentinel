...
| Full repository refactor and v2.9.5 readiness | Active | Finish company research root ownership | [Plan](repository-architecture-reorganization.md) |
...
1. Finish Milestone 2 with the company research root ownership family.
