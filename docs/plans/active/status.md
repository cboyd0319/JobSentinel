...
| Full repository refactor and v2.9.5 readiness | Active | Continue the remaining frontend buckets after assigning the shared location cache | [Plan](repository-architecture-reorganization.md) |
