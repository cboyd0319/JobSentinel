...
| Full repository refactor and v2.9.5 readiness | Active | Continue frontend ownership after completing the Resume library, builder, and matching slice | [Plan](repository-architecture-reorganization.md) |
