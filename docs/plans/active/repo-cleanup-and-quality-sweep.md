...
| 2026-05-28 | In progress | Replaced visible regex wording in One-Click Apply screening answers with plain question-text matching copy, changed common answer presets to readable phrases, updated tests/docs, and added bloat coverage for technical-first screening-answer copy. |
