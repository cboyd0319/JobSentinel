...
| Encrypted local storage | Active | SQLCipher, AEAD vault rows, legacy migration, and passphrase Settings controls exist; next: macOS native unlock. |
...
5. Continue encrypted storage UX: macOS native unlock and no passive Settings
   probes.
