...
function writeCompleteHarnessFixture(root) {
  ...
  writeFixtureFile(root, "scripts/tests/harness-benchmark.test.mjs", "");
  writeFixtureFile(root, "scripts/harness-plan.mjs", "");
  writeFixtureFile(root, "scripts/harness-score.mjs", "");
  writeFixtureFile(root, "scripts/tests/harness-score.test.mjs", "");
  writeFixtureFile(root, "scripts/tests/harness-session.test.mjs", "");

  for (let index = 0; index < 20; index += 1) {
    writeFixtureFile(root, `scripts/tests/generated-${index}.test.mjs`, "");
  }
}
