...
export function writeBaseRepo(root, csp) {
  ...
  writeFileSync(
    ...
    [
      ...
      "scripts/checks/action-pins.mjs @cboyd0319",
      "scripts/checks/dependency-pins.mjs @cboyd0319",
      "scripts/checks/security-sensors.mjs @cboyd0319",
      "scripts/tests/checks/check-security-sensors.test.mjs @cboyd0319",
      ...
      "deny.toml @cboyd0319",
      "crates/ @cboyd0319",
      "scripts/checks/ @cboyd0319",
      "scripts/platform/ @cboyd0319",
      "scripts/release/ @cboyd0319",
      "scripts/checks/repository-architecture.mjs @cboyd0319",
