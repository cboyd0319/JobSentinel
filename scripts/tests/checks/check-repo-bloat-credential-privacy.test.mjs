  ...
  withGitFixture((root) => {
    ...
    writeFixtureFile(
      ...
      [
        ...
        "  match key {",
        "    CredentialKey::SlackWebhook => validate_webhook_credential(value, WebhookTarget::Slack),",
        "    CredentialKey::DiscordWebhook => validate_webhook_credential(value, WebhookTarget::Discord),",
        "    CredentialKey::TeamsWebhook => validate_webhook_credential(value, WebhookTarget::Teams),",
        "    CredentialKey::TelegramBotToken => validate_telegram_bot_token_credential(value),",
        "    _ => Ok(()),",
        "  }",
        "}",
        "fn validate_webhook_credential(_value: &str, _target: WebhookTarget) -> Result<(), String> { Ok(()) }",
