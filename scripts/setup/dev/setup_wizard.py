...
class SetupWizard:
    ...
    def welcome(self) -> None:
        ...
        console.print("• Analyze your resume for skills and preferences")
        console.print("• Set up personalized job matching")
        console.print("• Configure location and remote work preferences")
        console.print("• Set salary expectations and career goals")
        console.print("• Choose which job boards to monitor")
        console.print("\n[bold green]Let's get started![/bold green]\n")

    def collect_basic_info(self) -> None:
        console.print("[bold blue]BASIC INFORMATION[/bold blue]")
    ...
    def analyze_resume(self) -> None:
        console.print("[bold blue]RESUME ANALYSIS[/bold blue]")
