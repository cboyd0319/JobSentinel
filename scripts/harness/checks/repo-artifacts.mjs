...
const legacyOversizedLineBudgets = new Map([
  ...
  ["src/pages/Settings.tsx", 2663],
  ["src-tauri/src/core/resume/ats_analyzer.rs", 3060],
  ["src-tauri/src/core/db/tests.rs", 2526],
  ["scripts/harness/checks/product-copy.mjs", 1763],
