...
const requiredFiles = [
  ...
  "docs/harness/walkinglabs-harness-creator-skill-evaluation.md",
  "docs/harness/walkinglabs-lecture-02-evaluation.md",
...
const requiredReadmeReferenceUrls = [
  ...
  "https://github.com/walkinglabs/learn-harness-engineering/tree/main/skills",
