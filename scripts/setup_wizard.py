...
class SetupWizard:
 ...
 console.print(f"[green][OK] Resume analyzed successfully! Found {len(parsed_data['skills'])} skills.[/green]")
 ...
 console.print(f"[bold red][ERROR] Error analyzing resume:[/bold red] {e}")
 ...
 console.print(f"[green][OK] Analysis complete! Found {len(self.user_profile['skills'])} skills[/green]")
 ...
 console.print("[yellow][WARNING] No skills detected automatically. Let's add them manually.[/yellow]")
 self._manual_skills_entry()

 except Exception as e:
 logger.error(f"[bold red]Resume analysis failed:[/bold red] {e}")
 console.print(f"[bold red][ERROR] Resume analysis failed:[/bold red] {e}")
 self._manual_skills_entry()
 ...
 console.print(f"[green][OK] Added {len(manual_skills)} skills[/green]")
 ...
 console.print(f"[bold red][WARNING] Invalid URL ({exc}). Please try again.[/bold red]")
 continue

 if sanitized in custom_urls:
 console.print("[yellow][WARNING] URL already added, skipping duplicate[/yellow]")
 continue
 ...
 if custom_urls:
 console.print(f"[green][OK] Added {len(custom_urls)} custom job boards[/green]")
 ...
 console.print(f"[green][OK] Configuration saved to {self.config_path}[/green]")
 console.print("[green][OK] Database initialized[/green]")

 except Exception as e:
 logger.error(f"[bold red]Failed to save configuration:[/bold red] {e}")
 console.print(f"[bold red][ERROR] Failed to save configuration:[/bold red] {e}")
 ...
 console.print("\n[bold red][ERROR] Setup failed:[/bold red] {e}")
 sys.exit(1)
