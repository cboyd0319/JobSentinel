...
from deployments.common.cloud.providers.gcp.teardown import GCPTeardown
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Simulate teardown without deleting any resources."
    )
