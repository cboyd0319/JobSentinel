...
pub struct EmailConfig {
    ...
    #[serde(default = "super::super::defaults::default_smtp_port")]
    pub smtp_port: u16,
    ...
    #[serde(default = "super::super::defaults::default_use_starttls")]
...
pub struct DesktopConfig {
    #[serde(default = "super::super::defaults::default_desktop_enabled")]
    pub enabled: bool,
    ...
    #[serde(default = "super::super::defaults::default_play_sound")]
    pub play_sound: bool,
}
