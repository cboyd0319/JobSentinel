...
mod tests {
    ...
    fn test_bookmarklet_code_includes_token_only_in_generated_button() {
        ...
        assert!(code.contains("ycombinator\\.com"));
        assert!(code.contains("Automated YC Startup access is unavailable"));
