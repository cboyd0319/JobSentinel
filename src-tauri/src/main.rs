...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::resume::get_resume_text_preview,
            ...
            commands::resume::resume_builder_commands::create_resume_draft,
            commands::resume::resume_builder_commands::get_resume_draft,
            commands::resume::resume_builder_commands::update_resume_contact,
            commands::resume::resume_builder_commands::update_resume_summary,
            commands::resume::resume_builder_commands::add_resume_experience,
            commands::resume::resume_builder_commands::delete_resume_experience,
            commands::resume::resume_builder_commands::add_resume_education,
            commands::resume::resume_builder_commands::delete_resume_education,
            commands::resume::resume_builder_commands::set_resume_skills,
            commands::resume::resume_builder_commands::delete_resume_draft,
